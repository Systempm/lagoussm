...
public class DbDataVo {
	...
	private String companshortname;
	...
	public String getCompanshortname() {
		return companshortname;
	}
	public void setCompanshortname(String companshortname) {
		this.companshortname = companshortname;
	}
	...
	public int getMaxjianminslary() {
		return Maxjianminslary;
	}
	public void setMaxjianminslary(int maxjianminslary) {
		Maxjianminslary = maxjianminslary;
	}
